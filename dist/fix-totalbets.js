...
const bet_schema_1 = require("./bets/bet.schema");
const user_schema_1 = require("./users/user.schema");
const dotenv = __importStar(require("dotenv"));
dotenv.config();
async function fix() {
    const app = await core_1.NestFactory.createApplicationContext(app_module_1.AppModule);
    const betModel = app.get((0, mongoose_1.getModelToken)(bet_schema_1.Bet.name));
...
//# sourceMappingURL=fix-totalbets.js.map